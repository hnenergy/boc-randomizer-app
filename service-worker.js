const CACHE='spinorder-draft-v9';
const ASSETS=['./','./index.html','./setup-state.js','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png','./assets/brand/spinorder-logo.svg','./assets/brand/lfn-legacy-apps-elephant.png'];
