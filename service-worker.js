const CACHE='spinorder-draft-v14';
const ASSETS=['./','./index.html','./setup-state.js','./participant-state.js','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png','./assets/brand/spinorder-logo.svg','./assets/brand/lfn-legacy-apps-elephant.png'];
