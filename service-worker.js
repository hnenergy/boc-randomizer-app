const CACHE='spinorder-draft-v26';
const ASSETS=['./','./index.html','./setup-state.js','./favicon-state.js','./participant-state.js','./position-state.js','./automation-state.js','./wheel-rotation.js','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png','./assets/icons/football.svg','./assets/icons/baseball.svg','./assets/icons/golf.svg','./assets/icons/basketball.svg','./assets/icons/generic.svg','./assets/brand/spinorder-logo.svg','./assets/brand/lfn-legacy-apps-elephant.png','./assets/brand/lfn-legacy-apps-elephant-light-blue.png','./assets/brand/lfn-legacy-apps-elephant-light-gray.png'];
